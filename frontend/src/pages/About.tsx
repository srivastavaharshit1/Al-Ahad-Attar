  ...
  return (
    <main className="flex-grow">
      ...
      <section className="relative w-full h-[614px] md:h-[819px] flex items-center justify-center overflow-hidden">
        <div className="absolute inset-0 w-full h-full bg-surface-container-lowest z-0">
          <img 
        ...
        <div className="relative z-10 text-center px-margin-mobile md:px-margin-desktop max-w-3xl mx-auto">
          <p className="font-label-sm text-label-sm text-primary uppercase tracking-widest mb-6">Our Philosophy</p>
          <h1 className="font-display-lg-mobile md:font-display-lg text-display-lg-mobile md:text-display-lg text-on-surface mb-8">The Alchemy of Stillness</h1>
          <p className="font-body-lg text-body-lg text-on-surface-variant max-w-2xl mx-auto">Where centuries of traditional Arabic perfumery converge with the quiet restraint of modern luxury. We craft not just scents, but moments of profound reflection.</p>
        </div>
      </section>
      ...
      <section className="py-section-gap px-margin-mobile md:px-margin-desktop max-w-container-max mx-auto">
        ...
        <div className="grid grid-cols-1 md:grid-cols-12 gap-gutter">
          ...
          <div className="md:col-span-8 bg-surface-container-lowest border border-[#E8E2D8] rounded-xl overflow-hidden hover:shadow-[0_10px_30px_rgba(31,41,55,0.04)] group relative min-h-[400px]">
            ...
            <div className="absolute bottom-0 left-0 p-8 z-20 text-on-primary">
              ...
              <p className="font-body-md text-body-md text-on-primary/80 max-w-md">Our lineage traces back to the ancient incense routes. Based in Ayodhya, the sacred land of Lord Rama, we preserve techniques passed down through generations of master distillers to bring divine fragrances to the world.</p>
            </div>
          </div>
          
          {/* Small block 1 */}
          <div className="md:col-span-4 bg-surface-container-lowest border border-[#E8E2D8] rounded-xl p-8 flex flex-col justify-center hover:shadow-[0_10px_30px_rgba(31,41,55,0.04)] transition-shadow">
            ...
            <p className="font-body-md text-body-md text-on-surface-variant">We source only the absolute highest grade of raw materials—rare ouds, wild-harvested resins, and pristine florals.</p>
          </div>
          ...
          <div className="md:col-span-4 bg-surface-container-lowest border border-[#E8E2D8] rounded-xl p-8 flex flex-col justify-center hover:shadow-[0_10px_30px_rgba(31,41,55,0.04)] transition-shadow">
            ...
            <p className="font-body-md text-body-md text-on-surface-variant">True luxury cannot be rushed. Our attars undergo extensive maturation processes in optimal conditions to achieve their final, complex profiles.</p>
          </div>
          
          {/* Medium block */}
          <div className="md:col-span-8 bg-surface-container-lowest border border-[#E8E2D8] rounded-xl overflow-hidden hover:shadow-[0_10px_30px_rgba(31,41,55,0.04)] group relative min-h-[300px]">
            <div className="absolute inset-0 w-full h-full overflow-hidden z-0">
              <img 
            ...
            <div className="absolute inset-0 bg-surface-container-lowest/80 backdrop-blur-sm z-10 flex flex-col justify-center p-12 transition-opacity duration-500 group-hover:bg-surface-container-lowest/90">
              ...
              <p className="font-body-md text-body-md text-on-surface-variant max-w-lg">While our roots are traditional, our vision is contemporary. We strip away the unnecessary, focusing on the profound beauty of singular, exquisite notes allowed to breathe in a minimalist composition.</p>
            </div>
          </div>
        </div>
      </section>
      ...
      <section className="py-section-gap bg-surface-bright border-t border-b border-outline-variant/30">
            ...
            <div className="w-full md:w-5/12 order-2 md:order-1">
              ...
              <ul className="space-y-4 mb-10">
                <li className="flex items-start">
                  ...
                  <span className="font-body-md text-body-md text-on-surface-variant">Traceable botanical origins.</span>
                </li>
                <li className="flex items-start">
                  <span className="material-symbols-outlined text-primary mr-3 mt-1">check</span>
                  <span className="font-body-md text-body-md text-on-surface-variant">Cruelty-free and vegan formulations.</span>
                </li>
                <li className="flex items-start">
                  <span className="material-symbols-outlined text-primary mr-3 mt-1">check</span>
                  <span className="font-body-md text-body-md text-on-surface-variant">Minimalist, recyclable packaging.</span>
                </li>
              </ul>
              <Link to="/contact" className="inline-block bg-primary text-on-primary font-label-md text-label-md px-8 py-3 rounded-DEFAULT hover:bg-surface-tint transition-colors duration-300">
                Read Our Manifesto
              </Link>
            </div>
            <div className="w-full md:w-7/12 order-1 md:order-2 relative">
              <div className="aspect-[4/5] md:aspect-[3/4] w-full rounded-xl overflow-hidden relative z-10 border border-[#E8E2D8]">
                <img 
      ...
      <section className="py-section-gap px-margin-mobile md:px-margin-desktop text-center">
        ...
        <p className="font-body-md text-body-md text-on-surface-variant mb-10 max-w-md mx-auto">Explore our foundational collections or inquire about our bespoke olfactory design services.</p>
        <div className="flex flex-col sm:flex-row justify-center items-center gap-4">
          <Link to="/collection" className="w-full sm:w-auto bg-primary text-on-primary font-label-md text-label-md px-8 py-3 rounded-DEFAULT hover:bg-surface-tint transition-colors duration-300 text-center">
            Explore Collections
          </Link>
          <Link to="/contact" className="w-full sm:w-auto bg-transparent text-on-surface font-label-md text-label-md px-8 py-3 rounded-DEFAULT border border-outline hover:border-primary hover:text-primary transition-colors duration-300 text-center">
            Bespoke Inquiries
          </Link>
        </div>
      </section>
